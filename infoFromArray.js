...
function findClosestSmaller (arr, item) {
    return this.findClosest(arr, item, (a, b) => {return a < b}).item
}
...
function getMinIndex(inputArray) {
    return this.getIndexValues(inputArray, (a, b) => {return a - b});
}

//Generated by chatgpt:
function getMaxIndex(inputArray) {
    return this.getIndexValues(inputArray, (a, b) => {return b - a});
}
