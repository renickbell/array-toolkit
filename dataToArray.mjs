...
*/
export function buildArray(n, fillFunction) {
...
*/
export function linearArray(start, step, numberOfSteps) {
...
*/
export function integerArray(start, numberOfSteps) {
...
*/
export function geometricArray(start, step, numberOfSteps) {
