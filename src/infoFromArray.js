...
/**
  ...
  * @param {array} arr - the array to get the item from
  * @param item - The array of numbers to sort through.
...
/**
  ...
  * @param {number} startingVal - The number to add all the numbers in the array to.
  * @param {number[]} inputArray - The array of numbers to add startingVal to.
...
/**
  ...
  * @param {number[]} inputArray - The array of numbers to find the average of.
...
/**
  ...
  * console.log(includesOneOf([0, 1, 2, 3], [5, 1000])) //false
*/
...
*/
function isArrayAscending(numbersArray) {
...
*/
function isArrayDescending(numbersArray) {
  return numbersArray.every((num, index) => {
    if (index === 0) {
      return true; // The first element is always considered in ascending order
    }
